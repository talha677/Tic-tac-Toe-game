...
let music = new Audio("./img src/music.mp3");   
let audioTurn = new Audio("./img src/ting.mp3");
let gameover = new Audio("./img src/gameover.mp3");
let turn = "X"
...
reset.addEventListener('click', () => {
    let textboxe = document.querySelectorAll('.textbox');
    Array.from(textboxe).forEach(element => {
        element.innerText =  ""
    });
    turn = "X"
    isgameover = false
